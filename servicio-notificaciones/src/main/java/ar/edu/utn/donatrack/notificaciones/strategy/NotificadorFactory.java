 ...
 *
 * El diagrama de clases modela la relación entre "Notificacion" y el medio
 * (vía el ENUM MedioComunicacion) y, por otro lado, la interface
 * "Notificador" con sus 3 implementaciones. Esta fábrica es la pieza que
 * conecta ambos mundos: dado el medio de una notificación, devuelve el
 ...
 * del sistema (principio Open/Closed).
 */
@Component
